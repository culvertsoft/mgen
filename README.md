...
The goal of MGen is to to simplify type-safe cross-language collaboration among software components and software teams that wish to share common data structures, allowing changes to the model design to be performed without requiring everyone to adapt or rebuild their software.
