...
In short - we chose to separate the concerns of data representation from data identity and transport method - the latter is not something MGen is concerned with at this point.
