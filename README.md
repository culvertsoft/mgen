...
This is where you can download the MGen source and learn how to build it. **If you want to know what MGen is** head over to our [preliminary project pages](http://culvertsoft.github.io/mgen/)
