...
public class ListType extends ListOrArrayType {
    ...
    public ListType(final FieldType elementType) {
        super(elementType);
    }

    public ListType unsetElementType() {
        _setElementTypeSet(false, FieldSetDepth.SHALLOW);
        return this;
    }

    public ListType setElementType(final FieldType elementType) {
    ...
    public String toString() {
        ...
        sb.append("se.culvertsoft.mgen.visualdesigner.model.ListType:\n");
    ...
    public boolean equals(final Object other) {
        ...
        if (ListType.class != other.getClass()) return false;
        final ListType o = (ListType)other;
        return true
    ...
    public ListType deepCopy() {
        final ListType out = new ListType();
 ...
 ********************************************************************************************************************/	 		  
    ...
    public ListType _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final Field _elementType_METADATA = new Field("se.culvertsoft.mgen.visualdesigner.model.ListType", "elementType", new se.culvertsoft.mgen.api.model.impl.UnknownCustomTypeImpl("se.culvertsoft.mgen.visualdesigner.model.FieldType"), java.util.Arrays.asList("polymorphic"));

    public static final short _elementType_HASH_16BIT = 1917;

    public static final int _elementType_HASH_32BIT = 911176325;

    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.ListType";
    public static final short _TYPE_HASH_16BIT = 4405;
    public static final int _TYPE_HASH_32BIT = 1582921468;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = 4405;
        _TYPE_HASHES_32BIT[4] = 1582921468;
        names.add("se.culvertsoft.mgen.visualdesigner.model.ListType");
        base6416bit.add("ETU");
        base6432bit.add("Xll2/A");
        _TYPE_NAMES = names;
