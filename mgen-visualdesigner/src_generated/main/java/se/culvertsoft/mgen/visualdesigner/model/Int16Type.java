...
public class Int16Type extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (Int16Type.class != other.getClass()) return false;
        return true;
    }

    @Override
    public Int16Type deepCopy() {
        final Int16Type out = new Int16Type();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public Int16Type _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.Int16Type";
    public static final short _TYPE_HASH_16BIT = -17902;
    public static final int _TYPE_HASH_32BIT = 136444489;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = -17902;
        _TYPE_HASHES_32BIT[4] = 136444489;
        names.add("se.culvertsoft.mgen.visualdesigner.model.Int16Type");
        base6416bit.add("uhI");
        base6432bit.add("CCH6SQ");
        _TYPE_NAMES = names;
