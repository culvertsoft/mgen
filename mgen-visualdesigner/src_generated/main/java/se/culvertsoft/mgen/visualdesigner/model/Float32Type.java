...
public class Float32Type extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (Float32Type.class != other.getClass()) return false;
        return true;
    }

    @Override
    public Float32Type deepCopy() {
        final Float32Type out = new Float32Type();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public Float32Type _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.Float32Type";
    public static final short _TYPE_HASH_16BIT = 8715;
    public static final int _TYPE_HASH_32BIT = 276382391;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = 8715;
        _TYPE_HASHES_32BIT[4] = 276382391;
        names.add("se.culvertsoft.mgen.visualdesigner.model.Float32Type");
        base6416bit.add("Igs");
        base6432bit.add("EHlCtw");
        _TYPE_NAMES = names;
