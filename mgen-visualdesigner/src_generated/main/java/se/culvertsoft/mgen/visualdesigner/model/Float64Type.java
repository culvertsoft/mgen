...
public class Float64Type extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (Float64Type.class != other.getClass()) return false;
        return true;
    }

    @Override
    public Float64Type deepCopy() {
        final Float64Type out = new Float64Type();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public Float64Type _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.Float64Type";
    public static final short _TYPE_HASH_16BIT = -21361;
    public static final int _TYPE_HASH_32BIT = -806082908;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = -21361;
        _TYPE_HASHES_32BIT[4] = -806082908;
        names.add("se.culvertsoft.mgen.visualdesigner.model.Float64Type");
        base6416bit.add("rI8");
        base6432bit.add("z/QmpA");
        _TYPE_NAMES = names;
