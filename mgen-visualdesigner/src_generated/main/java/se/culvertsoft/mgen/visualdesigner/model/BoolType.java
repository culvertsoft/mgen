...
public class BoolType extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (BoolType.class != other.getClass()) return false;
        return true;
    }

    @Override
    public BoolType deepCopy() {
        final BoolType out = new BoolType();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public BoolType _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.BoolType";
    public static final short _TYPE_HASH_16BIT = 14609;
    public static final int _TYPE_HASH_32BIT = 210194263;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = 14609;
        _TYPE_HASHES_32BIT[4] = 210194263;
        names.add("se.culvertsoft.mgen.visualdesigner.model.BoolType");
        base6416bit.add("ORE");
        base6432bit.add("DIdPVw");
        _TYPE_NAMES = names;
