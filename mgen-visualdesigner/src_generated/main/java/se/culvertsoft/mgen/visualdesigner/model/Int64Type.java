...
public class Int64Type extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (Int64Type.class != other.getClass()) return false;
        return true;
    }

    @Override
    public Int64Type deepCopy() {
        final Int64Type out = new Int64Type();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public Int64Type _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.Int64Type";
    public static final short _TYPE_HASH_16BIT = 14032;
    public static final int _TYPE_HASH_32BIT = 1877252497;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = 14032;
        _TYPE_HASHES_32BIT[4] = 1877252497;
        names.add("se.culvertsoft.mgen.visualdesigner.model.Int64Type");
        base6416bit.add("NtA");
        base6432bit.add("b+SZkQ");
        _TYPE_NAMES = names;
