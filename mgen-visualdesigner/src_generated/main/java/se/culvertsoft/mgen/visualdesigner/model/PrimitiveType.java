...
public class PrimitiveType extends SimpleType {
    ...
    public boolean equals(final Object other) {
        ...
        if (PrimitiveType.class != other.getClass()) return false;
        return true;
    }

    @Override
    public PrimitiveType deepCopy() {
        final PrimitiveType out = new PrimitiveType();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public PrimitiveType _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.PrimitiveType";
    public static final short _TYPE_HASH_16BIT = 10783;
    public static final int _TYPE_HASH_32BIT = -382209008;
