...
public class Int32Type extends PrimitiveType {
    ...
    public boolean equals(final Object other) {
        ...
        if (Int32Type.class != other.getClass()) return false;
        return true;
    }

    @Override
    public Int32Type deepCopy() {
        final Int32Type out = new Int32Type();
        return out;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public Int32Type _setAllFieldsSet(final boolean state, final FieldSetDepth depth) { 
        return this;
    }
 ...
 ********************************************************************************************************************/	 		  
    ...
    public static final String _TYPE_NAME = "se.culvertsoft.mgen.visualdesigner.model.Int32Type";
    public static final short _TYPE_HASH_16BIT = -18348;
    public static final int _TYPE_HASH_32BIT = -1335231102;
    ...
    static {
        ...
        _TYPE_HASHES_16BIT[4] = -18348;
        _TYPE_HASHES_32BIT[4] = -1335231102;
        names.add("se.culvertsoft.mgen.visualdesigner.model.Int32Type");
        base6416bit.add("uFQ");
        base6432bit.add("sGn9gg");
        _TYPE_NAMES = names;
