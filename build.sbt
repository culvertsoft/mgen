...
lazy val mgen_idlgenerator = (project in file("mgen-idlgenerator")).dependsOn(mgen_api, mgen_compiler)
...
lazy val mgen_visualdesigner = (project in file("mgen-visualdesigner")).dependsOn(mgen_api, mgen_idlparser, mgen_compiler, mgen_javalib, mgen_javagenerator)
