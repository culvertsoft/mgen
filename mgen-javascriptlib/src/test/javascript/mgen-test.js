...
(function(){
	...
	it( "Testing Jasmine framework is set up.", function(){
		expect( true ).toEqual( true );
	});

	it( "Testing that all functions and tables needed are in place.", function(){
		expect( mgen_classreg ).toBeDefined();
		expect( mGenGenerate ).toBeDefined();
	});
