...
(function() {
    ...
    var mGen = {
        ...
        generate: function(classRegistryBlueprint, settings) {
            ...
            /**
             * The classRegistry is a object that classes created from the classRegistryBlueprint
             *
             */
            classRegistry = function() {
                // Shouldn't be a constructor. But I prefere helping the user instead of the generic "X is not a constructor" error.
                throw "Do not call a classRegistry with new! \n" +
                    " You probably wanted to do something like: new classRegistry.package.path.ClassName()";
            };
